...
- **Lec 1** Renee DiResta ["How do we know what's true anymore"](https://www.youtube.com/watch?v=vIkJoUeoY-o) and ["Disinformation & How To Combat It"](https://www.youtube.com/watch?v=YG_qFv83gpA)
...
- [How to spot deepfakes and AI-generated images](https://www.youtube.com/watch?v=7akzhpx0EIU)
- [This is a good introduction to deepfakes anchored in a current event from a few years ago.](https://www.youtube.com/watch?v=70l8LzBpGWs)
  - A couple of other great quality deepfakes are [this now classic obama interview](https://www.youtube.com/watch?v=cQ54GDm1eL0), this [paper review of how to deepfake voices](https://www.youtube.com/watch?v=VQgYPv8tb6A), and this [brief report including how to detect deepfakes](https://www.youtube.com/watch?v=4YpoYvhVmDw) (there are many more deepfakes videos out there).
- The input required to make simpler deepfakes is often just a single photo. This is leveraged by MyHeritage, a company for building family trees online that now offers to [animate photos of your deceased relatives through their Deep Nostaliga algorithm](https://www.myheritage.com/deep-nostalgia). Creepy and uncanny? Or just the future you have been waiting for since the first time you read Harry Potter? - I recommend watching the black mirror episode "Be right back" for an extension of this concept to three dimensions. - [I really recommend the (publicly available) short story "Thoughts and prayers"](https://slate.com/technology/2019/01/thoughts-and-prayers-ken-liu-short-story.html) from Ken Liu on what goes wrong when a family agrees to create a digital reanimation of their daughter to raise awareness of the mass-shooting that caused her death (if you like this one, check out his books "The paper menagerie and other short stories" and "The hidden girl and other short stories").
</details>
...
<ul>
  ...
  <li>Include a clickable link to your GitHub repo for the lab just below this cell
    <ul>
      ...
      <li>If you are working in a group, you can create you own (public) repo in <a href="https://github.ubc.ca/MDS-2025-26"> the UBC-MDS organization</a> and link that instead.</li>
    </ul>
  </li>
...
https://github.com/UBC-MDS/DSCI-541-Lab1-SG#
...
1. The main difference between misinformation and disinformation is motivation. Misinformation is the unintentional spread of false information by people(s) who genuinely believe it to be true without malicious intent. On the other hand, disinformation is a purposeful act of spreading false information with the intent of causing harm or for personal gain.

2. The general goal of a disinformation campaign is to deceive a target audience and influence public opinion (this can apply beyond political agendas, for example: a company can create a disinformation campaign to harm the reputation of a competitor). One common method used is to create fake 'bot' accounts in order to appear as if there is a mass support of the disinformation in question.

3. An online echo chamber is an environment where users are only exposed to information that confirms their pre-existing beliefs and limits opposing opinions. This can foster extremist attitudes and result in a polarizing 'bubble' or 'closed loop'.

4. Deepfakes are a form of identity fraud or spoofing where a person's likeness (image and/or voice) is convincingly falsified through artificial intelligence. These videos/images/audios can be either completely generated or existing media that has been edited.

5. The statement 'If you can make it trend, you can make it true' refers to the notion that with enough repetition and widespread exposure, a concept can be falsely perceived as true or credible even if it is not. This plays on the human psychological tendency to place higher trust in reinforced messages.

6. Goodhart's Law states that "When a measure becomes a target, it ceases to be a good measure". In layman's terms, if using a certain metric to evaluate success, the behaviour shifts to maximize that metric rather than focusing on achieving the original goal. A common example used dates back to the British rule in India, when bounties were placed on venomous cobras in Delhi with the intention of controlling their population. However, people instead began breeding these cobras just to kill them and collect the bounty, which resulted in an increase in the population of venomous cobras.
